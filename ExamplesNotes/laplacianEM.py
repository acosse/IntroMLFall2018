...
Y1 = manifold.SpectralEmbedding(n_components=n_components,n_neighbors=n_neighbors).fit_transform(X1)
...
Y2 = manifold.SpectralEmbedding(n_components=n_components,n_neighbors=n_neighbors).fit_transform(X2)
...
Y3 = manifold.SpectralEmbedding(n_components=n_components,n_neighbors=n_neighbors).fit_transform(sphere_data).T
...
ax2.set_title('Laplacian EM Embedding')
plt.locator_params(axis='y', nbins=3)
plt.locator_params(axis='x', nbins=3)
plt.locator_params(axis='z', nbins=3)
...
ax4.set_title('Laplacian EM Embedding')
plt.locator_params(axis='y', nbins=3)
plt.locator_params(axis='x', nbins=3)
plt.locator_params(axis='z', nbins=3)
...
ax6.set_title('Laplacian EM Embedding')
plt.locator_params(axis='y', nbins=3)
plt.locator_params(axis='x', nbins=3)
plt.locator_params(axis='z', nbins=3)
...
fig.tight_layout()
fig.savefig('/Users/acosse/Desktop/Teaching/Machine Learning/syllabus/Deep learning class/figures/LaplacianEM1')
