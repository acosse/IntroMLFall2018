...
Y1 =  manifold.MDS(n_components, max_iter=100, n_init=1).fit_transform(X1)
...
Y2 =  manifold.MDS(n_components, max_iter=100, n_init=1).fit_transform(X2)
...
Y3 =  manifold.MDS(n_components, max_iter=100, n_init=1).fit_transform(sphere_data).T
...
fig.tight_layout()
fig.savefig('/Users/acosse/Desktop/Teaching/Machine Learning/syllabus/Deep learning class/figures/MDS1')
